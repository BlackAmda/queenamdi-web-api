...
exports.MimetypeMap = exports.MediaPathMap = exports.GroupSettingChange = exports.Mimetype = exports.HKDFInfoKeys = exports.ChatModification = exports.MessageTypeProto = exports.MessageType = exports.Presence = exports.WAFlag = exports.STORIES_JID = exports.WAMetric = exports.DisconnectReason = exports.UNAUTHORIZED_CODES = exports.URL_REGEX = exports.ReconnectMode = exports.CancelledError = exports.TimedOutError = exports.AmdiWebError = exports.WA_MESSAGE_STUB_TYPES = exports.WA_MESSAGE_STATUS_TYPE = exports.WA_MESSAGE_STUB_TYPE = exports.WAMessageProto = exports.WA_DEFAULT_EPHEMERAL = exports.KEEP_ALIVE_INTERVAL_MS = exports.DEFAULT_ORIGIN = exports.WS_URL = void 0;
...
class AmdiWebError extends Error {
    constructor(message, context, stack) {
        super(message);
        this.name = 'AmdiWebError';
...
exports.AmdiWebError = AmdiWebError;
const TimedOutError = (stack) => new AmdiWebError('timed out', { status: 408 }, stack);
exports.TimedOutError = TimedOutError;
const CancelledError = (stack) => new AmdiWebError('cancelled', { status: 500 }, stack);
